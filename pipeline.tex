...
\todo{Maybe add pictures or parameters used in n-gram and feature hashing}
...
\todo{clearer pictures of pipeline parts}
...
\todo{picture of all data processing steps from anonymizing to ml training}
%% TODO: picture of all data processing steps from anonymizing to ml training
