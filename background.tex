...
In ML, 
algorithms can be generally divided into <four> categories %% TODO: check
...
%% TODO: this should be basically covered above
...
%% käytännön puolesta, miten käytönnössä,
%% ei liikaa teoriaa ja taustaa
