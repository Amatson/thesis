...
which could be called intelligent, %% TODO: if IPA is used, it is somewhat intelligent!
...
\toimhuom{This chapter is good to go!}
...
explains in detail %% TODO: ?!?
the data format and contents
as well as the steps used in each... %% TODO: CLEARER!
\textbf{Results} section reveals how the selected algorithms performed
and how well the research questions could be answered %% TODO. Omstart...
Finally,
